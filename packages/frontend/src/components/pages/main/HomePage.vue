    ...
    <div class="mt-6 max-w-md justify-center">
      ...
      <div class="mt-8">
        <section>
          ...
          <div class="mt-5">
            <p>
              In the first exercise the goal would be to extend the current app with some additional output. For this
              you should integrate an public available Rest-API or GraphQL-API (see below for examples).
            </p>
            <p>
              It's your own decision what kind of output you use and in which way it will be displayed, but it should be
              in a creative way and you can use this possibility to show us your existing skills. For example you can
              add a list output as a starting point and show additional information in a detail page (or other output
              types).
            </p>
            <br />
        ...
        <section v-if="exerciseVisibilityState.third" class="mt-10">
          ...
          <div class="mt-5">
            <p>
              Please integrate a testing library in the current app. We're pretty sure that you have some components
